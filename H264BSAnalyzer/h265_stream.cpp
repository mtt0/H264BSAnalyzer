...
#define H265_LOG(...) fprintf(stdout, __VA_ARGS__)
...
int h265_read_nal_unit(h265_stream_t* h, uint8_t* buf, int size)
{
  ...
  switch (nal->nal_unit_type)
  {
    ...
    case NAL_UNIT_RESERVED_VCL31:
      H265_LOG("Note: found reserved VCL NAL unit.\n");
      nal->parsed = NULL;
      nal->sizeof_parsed = 0;
      break;
    ...
    case NAL_UNIT_RESERVED_NVCL47:
      H265_LOG("Note: found reserved NAL unit.\n");
      nal->parsed = NULL;
      nal->sizeof_parsed = 0;
      break;
    ...
    case NAL_UNIT_UNSPECIFIED_63:
      H265_LOG("Note: found unspecified NAL unit.\n");
      nal->parsed = NULL;
      nal->sizeof_parsed = 0;
      break;
    default:
...
void profile_tier_level_init(profile_tier_level_t *ptl) {
  ...
  ptl->general_progressive_source_flag = 0;
  ptl->general_interlaced_source_flag = 0;
  ptl->general_non_packed_constraint_flag = 0;
  ptl->general_frame_only_constraint_flag = 0;
  ptl->general_max_12bit_constraint_flag = 0;
  ...
  ptl->general_intra_constraint_flag = 0;
  ptl->general_one_picture_only_constraint_flag = 0;
  ptl->general_lower_bit_rate_constraint_flag = 0;
  ptl->general_reserved_zero_34bits = 0;
  ptl->general_reserved_zero_43bits = 0;
  ptl->general_inbld_flag = 0;
  ptl->general_reserved_zero_bit = 0;
  ptl->general_level_idc = 0;
}

void profile_tier_level_copy(profile_tier_level_t *src, profile_tier_level_t *dst) {
  ...
  memcpy(dst->general_profile_compatibility_flag, src->general_profile_compatibility_flag, sizeof(dst->general_profile_compatibility_flag));
  dst->general_progressive_source_flag = src->general_progressive_source_flag;
  dst->general_interlaced_source_flag = src->general_interlaced_source_flag;
  dst->general_non_packed_constraint_flag = src->general_non_packed_constraint_flag;
  dst->general_frame_only_constraint_flag = src->general_frame_only_constraint_flag;
  dst->general_max_12bit_constraint_flag = src->general_max_12bit_constraint_flag;
  dst->general_max_10bit_constraint_flag = src->general_max_10bit_constraint_flag;
  dst->general_max_8bit_constraint_flag = src->general_max_8bit_constraint_flag;
  dst->general_max_422chroma_constraint_flag = src->general_max_422chroma_constraint_flag;
  dst->general_max_420chroma_constraint_flag = src->general_max_420chroma_constraint_flag;
  dst->general_max_monochrome_constraint_flag = src->general_max_monochrome_constraint_flag;
  dst->general_intra_constraint_flag = src->general_intra_constraint_flag;
  dst->general_one_picture_only_constraint_flag = src->general_one_picture_only_constraint_flag;
  dst->general_lower_bit_rate_constraint_flag = src->general_lower_bit_rate_constraint_flag;
  dst->general_reserved_zero_34bits = src->general_reserved_zero_34bits;
  dst->general_reserved_zero_43bits = src->general_reserved_zero_43bits;
  dst->general_inbld_flag = src->general_inbld_flag;
  dst->general_reserved_zero_bit = src->general_reserved_zero_bit;
  dst->general_level_idc = src->general_level_idc;

  dst->sub_layer_profile_present_flag = src->sub_layer_profile_present_flag;
  dst->sub_layer_level_present_flag = src->sub_layer_level_present_flag;
  memcpy(dst->reserved_zero_2bits, src->reserved_zero_2bits, sizeof(dst->reserved_zero_2bits));
  dst->sub_layer_profile_space = src->sub_layer_profile_space;
  dst->sub_layer_tier_flag = src->sub_layer_tier_flag;
  dst->sub_layer_profile_idc = src->sub_layer_profile_idc;
  dst->sub_layer_profile_compatibility_flag = src->sub_layer_profile_compatibility_flag;
  dst->sub_layer_progressive_source_flag = src->sub_layer_progressive_source_flag;
  dst->sub_layer_interlaced_source_flag = src->sub_layer_interlaced_source_flag;
  dst->sub_layer_non_packed_constraint_flag = src->sub_layer_non_packed_constraint_flag;
  dst->sub_layer_frame_only_constraint_flag = src->sub_layer_frame_only_constraint_flag;
  dst->sub_layer_max_12bit_constraint_flag = src->sub_layer_max_12bit_constraint_flag;
  dst->sub_layer_max_10bit_constraint_flag = src->sub_layer_max_10bit_constraint_flag;
  dst->sub_layer_max_8bit_constraint_flag = src->sub_layer_max_8bit_constraint_flag;
  dst->sub_layer_max_422chroma_constraint_flag = src->sub_layer_max_422chroma_constraint_flag;
  dst->sub_layer_max_420chroma_constraint_flag = src->sub_layer_max_420chroma_constraint_flag;
  dst->sub_layer_max_monochrome_constraint_flag = src->sub_layer_max_monochrome_constraint_flag;
  dst->sub_layer_intra_constraint_flag = src->sub_layer_intra_constraint_flag;
  dst->sub_layer_one_picture_only_constraint_flag = src->sub_layer_one_picture_only_constraint_flag;
  dst->sub_layer_lower_bit_rate_constraint_flag = src->sub_layer_lower_bit_rate_constraint_flag;
  dst->sub_layer_reserved_zero_34bits = src->sub_layer_reserved_zero_34bits;
  dst->sub_layer_reserved_zero_43bits = src->sub_layer_reserved_zero_43bits;
  dst->sub_layer_inbld_flag = src->sub_layer_inbld_flag;
  dst->sub_layer_reserved_zero_bit = src->sub_layer_reserved_zero_bit;
  dst->sub_layer_level_idc = src->sub_layer_level_idc;
}
...
void  h265_read_sps_rbsp(h265_stream_t* h, bs_t* b)
{
  ...
  profile_tier_level_init(&profile_tier_level);
  ...
  profile_tier_level_copy(&(sps->ptl), &profile_tier_level);
