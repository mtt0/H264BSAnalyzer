...
#define H264_LOG(...) fprintf(stdout, __VA_ARGS__)
...
#define DBG \
  H264_LOG("line %d:",  __LINE__ ); \
  debug_bs(b); \
  b2->p = b2->start; b2->bits_left = 8; \
  /* read_slice_header(h2, b2); */\
  /* if (h2->sh->drpm.adaptive_ref_pic_marking_mode_flag) { H264_LOG(" X"); }; */ \
  H264_LOG("\n"); \
...
{
  H264_LOG("======= SPS =======\n");
  H264_LOG(" profile_idc : %d \n", sps->profile_idc);
  H264_LOG(" constraint_set0_flag : %d \n", sps->constraint_set0_flag);
  H264_LOG(" constraint_set1_flag : %d \n", sps->constraint_set1_flag);
  H264_LOG(" constraint_set2_flag : %d \n", sps->constraint_set2_flag);
  H264_LOG(" constraint_set3_flag : %d \n", sps->constraint_set3_flag);
  H264_LOG(" constraint_set4_flag : %d \n", sps->constraint_set4_flag);
  H264_LOG(" constraint_set5_flag : %d \n", sps->constraint_set5_flag);
  H264_LOG(" reserved_zero_2bits : %d \n", sps->reserved_zero_2bits);
  H264_LOG(" level_idc : %d \n", sps->level_idc);
  H264_LOG(" seq_parameter_set_id : %d \n", sps->seq_parameter_set_id);
  H264_LOG(" chroma_format_idc : %d \n", sps->chroma_format_idc);
  H264_LOG(" separate_colour_plane_flag : %d \n", sps->separate_colour_plane_flag);
  H264_LOG(" bit_depth_luma_minus8 : %d \n", sps->bit_depth_luma_minus8);
  H264_LOG(" bit_depth_chroma_minus8 : %d \n", sps->bit_depth_chroma_minus8);
  H264_LOG(" qpprime_y_zero_transform_bypass_flag : %d \n", sps->qpprime_y_zero_transform_bypass_flag);
  H264_LOG(" seq_scaling_matrix_present_flag : %d \n", sps->seq_scaling_matrix_present_flag);
  //  int seq_scaling_list_present_flag[8];
  //  void* ScalingList4x4[6];
  //  int UseDefaultScalingMatrix4x4Flag[6];
  //  void* ScalingList8x8[2];
  //  int UseDefaultScalingMatrix8x8Flag[2];
  H264_LOG(" log2_max_frame_num_minus4 : %d \n", sps->log2_max_frame_num_minus4);
  H264_LOG(" pic_order_cnt_type : %d \n", sps->pic_order_cnt_type);
  H264_LOG("   log2_max_pic_order_cnt_lsb_minus4 : %d \n", sps->log2_max_pic_order_cnt_lsb_minus4);
  H264_LOG("   delta_pic_order_always_zero_flag : %d \n", sps->delta_pic_order_always_zero_flag);
  H264_LOG("   offset_for_non_ref_pic : %d \n", sps->offset_for_non_ref_pic);
  H264_LOG("   offset_for_top_to_bottom_field : %d \n", sps->offset_for_top_to_bottom_field);
  H264_LOG("   num_ref_frames_in_pic_order_cnt_cycle : %d \n", sps->num_ref_frames_in_pic_order_cnt_cycle);
  //  int offset_for_ref_frame[256];
  H264_LOG(" max_num_ref_frames : %d \n", sps->max_num_ref_frames);
  H264_LOG(" gaps_in_frame_num_value_allowed_flag : %d \n", sps->gaps_in_frame_num_value_allowed_flag);
  H264_LOG(" pic_width_in_mbs_minus1 : %d \n", sps->pic_width_in_mbs_minus1);
  H264_LOG(" pic_height_in_map_units_minus1 : %d \n", sps->pic_height_in_map_units_minus1);
  H264_LOG(" frame_mbs_only_flag : %d \n", sps->frame_mbs_only_flag);
  H264_LOG(" mb_adaptive_frame_field_flag : %d \n", sps->mb_adaptive_frame_field_flag);
  H264_LOG(" direct_8x8_inference_flag : %d \n", sps->direct_8x8_inference_flag);
  H264_LOG(" frame_cropping_flag : %d \n", sps->frame_cropping_flag);
  H264_LOG("   frame_crop_left_offset : %d \n", sps->frame_crop_left_offset);
  H264_LOG("   frame_crop_right_offset : %d \n", sps->frame_crop_right_offset);
  H264_LOG("   frame_crop_top_offset : %d \n", sps->frame_crop_top_offset);
  H264_LOG("   frame_crop_bottom_offset : %d \n", sps->frame_crop_bottom_offset);
  H264_LOG(" vui_parameters_present_flag : %d \n", sps->vui_parameters_present_flag);

  H264_LOG("=== VUI ===\n");
  H264_LOG(" aspect_ratio_info_present_flag : %d \n", sps->vui.aspect_ratio_info_present_flag);
  H264_LOG("   aspect_ratio_idc : %d \n", sps->vui.aspect_ratio_idc);
  H264_LOG("     sar_width : %d \n", sps->vui.sar_width);
  H264_LOG("     sar_height : %d \n", sps->vui.sar_height);
  H264_LOG(" overscan_info_present_flag : %d \n", sps->vui.overscan_info_present_flag);
  H264_LOG("   overscan_appropriate_flag : %d \n", sps->vui.overscan_appropriate_flag);
  H264_LOG(" video_signal_type_present_flag : %d \n", sps->vui.video_signal_type_present_flag);
  H264_LOG("   video_format : %d \n", sps->vui.video_format);
  H264_LOG("   video_full_range_flag : %d \n", sps->vui.video_full_range_flag);
  H264_LOG("   colour_description_present_flag : %d \n", sps->vui.colour_description_present_flag);
  H264_LOG("     colour_primaries : %d \n", sps->vui.colour_primaries);
  H264_LOG("   transfer_characteristics : %d \n", sps->vui.transfer_characteristics);
  H264_LOG("   matrix_coefficients : %d \n", sps->vui.matrix_coefficients);
  H264_LOG(" chroma_loc_info_present_flag : %d \n", sps->vui.chroma_loc_info_present_flag);
  H264_LOG("   chroma_sample_loc_type_top_field : %d \n", sps->vui.chroma_sample_loc_type_top_field);
  H264_LOG("   chroma_sample_loc_type_bottom_field : %d \n", sps->vui.chroma_sample_loc_type_bottom_field);
  H264_LOG(" timing_info_present_flag : %d \n", sps->vui.timing_info_present_flag);
  H264_LOG("   num_units_in_tick : %d \n", sps->vui.num_units_in_tick);
  H264_LOG("   time_scale : %d \n", sps->vui.time_scale);
  H264_LOG("   fixed_frame_rate_flag : %d \n", sps->vui.fixed_frame_rate_flag);
  H264_LOG(" nal_hrd_parameters_present_flag : %d \n", sps->vui.nal_hrd_parameters_present_flag);
  H264_LOG(" vcl_hrd_parameters_present_flag : %d \n", sps->vui.vcl_hrd_parameters_present_flag);
  H264_LOG("   low_delay_hrd_flag : %d \n", sps->vui.low_delay_hrd_flag);
  H264_LOG(" pic_struct_present_flag : %d \n", sps->vui.pic_struct_present_flag);
  H264_LOG(" bitstream_restriction_flag : %d \n", sps->vui.bitstream_restriction_flag);
  H264_LOG("   motion_vectors_over_pic_boundaries_flag : %d \n", sps->vui.motion_vectors_over_pic_boundaries_flag);
  H264_LOG("   max_bytes_per_pic_denom : %d \n", sps->vui.max_bytes_per_pic_denom);
  H264_LOG("   max_bits_per_mb_denom : %d \n", sps->vui.max_bits_per_mb_denom);
  H264_LOG("   log2_max_mv_length_horizontal : %d \n", sps->vui.log2_max_mv_length_horizontal);
  H264_LOG("   log2_max_mv_length_vertical : %d \n", sps->vui.log2_max_mv_length_vertical);
  H264_LOG("   num_reorder_frames : %d \n", sps->vui.num_reorder_frames);
  H264_LOG("   max_dec_frame_buffering : %d \n", sps->vui.max_dec_frame_buffering);

  H264_LOG("=== HRD ===\n");
  H264_LOG(" cpb_cnt_minus1 : %d \n", sps->hrd.cpb_cnt_minus1);
  H264_LOG(" bit_rate_scale : %d \n", sps->hrd.bit_rate_scale);
  H264_LOG(" cpb_size_scale : %d \n", sps->hrd.cpb_size_scale);
  int SchedSelIdx;
  for (SchedSelIdx = 0; SchedSelIdx <= sps->hrd.cpb_cnt_minus1; SchedSelIdx++)
  {
    H264_LOG("   bit_rate_value_minus1[%d] : %d \n", SchedSelIdx, sps->hrd.bit_rate_value_minus1[SchedSelIdx]); // up to cpb_cnt_minus1, which is <= 31
    H264_LOG("   cpb_size_value_minus1[%d] : %d \n", SchedSelIdx, sps->hrd.cpb_size_value_minus1[SchedSelIdx]);
    H264_LOG("   cbr_flag[%d] : %d \n", SchedSelIdx, sps->hrd.cbr_flag[SchedSelIdx]);
  }
  H264_LOG(" initial_cpb_removal_delay_length_minus1 : %d \n", sps->hrd.initial_cpb_removal_delay_length_minus1);
  H264_LOG(" cpb_removal_delay_length_minus1 : %d \n", sps->hrd.cpb_removal_delay_length_minus1);
  H264_LOG(" dpb_output_delay_length_minus1 : %d \n", sps->hrd.dpb_output_delay_length_minus1);
  H264_LOG(" time_offset_length : %d \n", sps->hrd.time_offset_length);
}
...
{
  H264_LOG("======= PPS =======\n");
  H264_LOG(" pic_parameter_set_id : %d \n", pps->pic_parameter_set_id);
  H264_LOG(" seq_parameter_set_id : %d \n", pps->seq_parameter_set_id);
  H264_LOG(" entropy_coding_mode_flag : %d \n", pps->entropy_coding_mode_flag);
  H264_LOG(" pic_order_present_flag : %d \n", pps->pic_order_present_flag);
  H264_LOG(" num_slice_groups_minus1 : %d \n", pps->num_slice_groups_minus1);
  H264_LOG(" slice_group_map_type : %d \n", pps->slice_group_map_type);
  ...
  H264_LOG(" num_ref_idx_l0_active_minus1 : %d \n", pps->num_ref_idx_l0_active_minus1);
  H264_LOG(" num_ref_idx_l1_active_minus1 : %d \n", pps->num_ref_idx_l1_active_minus1);
  H264_LOG(" weighted_pred_flag : %d \n", pps->weighted_pred_flag);
  H264_LOG(" weighted_bipred_idc : %d \n", pps->weighted_bipred_idc);
  H264_LOG(" pic_init_qp_minus26 : %d \n", pps->pic_init_qp_minus26);
  H264_LOG(" pic_init_qs_minus26 : %d \n", pps->pic_init_qs_minus26);
  H264_LOG(" chroma_qp_index_offset : %d \n", pps->chroma_qp_index_offset);
  H264_LOG(" deblocking_filter_control_present_flag : %d \n", pps->deblocking_filter_control_present_flag);
  H264_LOG(" constrained_intra_pred_flag : %d \n", pps->constrained_intra_pred_flag);
  H264_LOG(" redundant_pic_cnt_present_flag : %d \n", pps->redundant_pic_cnt_present_flag);
  H264_LOG(" transform_8x8_mode_flag : %d \n", pps->transform_8x8_mode_flag);
  H264_LOG(" pic_scaling_matrix_present_flag : %d \n", pps->pic_scaling_matrix_present_flag);
  //  int pic_scaling_list_present_flag[8];
  //  void* ScalingList4x4[6];
  //  int UseDefaultScalingMatrix4x4Flag[6];
  //  void* ScalingList8x8[2];
  //  int UseDefaultScalingMatrix8x8Flag[2];
  H264_LOG(" second_chroma_qp_index_offset : %d \n", pps->second_chroma_qp_index_offset);
}

void debug_slice_header(slice_header_t* sh)
{
  H264_LOG("======= Slice Header =======\n");
  H264_LOG(" first_mb_in_slice : %d \n", sh->first_mb_in_slice);
  ...
  H264_LOG(" slice_type : %d ( %s ) \n", sh->slice_type, slice_type_name);

  H264_LOG(" pic_parameter_set_id : %d \n", sh->pic_parameter_set_id);
  H264_LOG(" frame_num : %d \n", sh->frame_num);
  H264_LOG(" field_pic_flag : %d \n", sh->field_pic_flag);
  H264_LOG(" bottom_field_flag : %d \n", sh->bottom_field_flag);
  H264_LOG(" idr_pic_id : %d \n", sh->idr_pic_id);
  H264_LOG(" pic_order_cnt_lsb : %d \n", sh->pic_order_cnt_lsb);
  H264_LOG(" delta_pic_order_cnt_bottom : %d \n", sh->delta_pic_order_cnt_bottom);
  // int delta_pic_order_cnt[ 2 ];
  H264_LOG(" redundant_pic_cnt : %d \n", sh->redundant_pic_cnt);
  H264_LOG(" direct_spatial_mv_pred_flag : %d \n", sh->direct_spatial_mv_pred_flag);
  H264_LOG(" num_ref_idx_active_override_flag : %d \n", sh->num_ref_idx_active_override_flag);
  H264_LOG(" num_ref_idx_l0_active_minus1 : %d \n", sh->num_ref_idx_l0_active_minus1);
  H264_LOG(" num_ref_idx_l1_active_minus1 : %d \n", sh->num_ref_idx_l1_active_minus1);
  H264_LOG(" cabac_init_idc : %d \n", sh->cabac_init_idc);
  H264_LOG(" slice_qp_delta : %d \n", sh->slice_qp_delta);
  H264_LOG(" sp_for_switch_flag : %d \n", sh->sp_for_switch_flag);
  H264_LOG(" slice_qs_delta : %d \n", sh->slice_qs_delta);
  H264_LOG(" disable_deblocking_filter_idc : %d \n", sh->disable_deblocking_filter_idc);
  H264_LOG(" slice_alpha_c0_offset_div2 : %d \n", sh->slice_alpha_c0_offset_div2);
  H264_LOG(" slice_beta_offset_div2 : %d \n", sh->slice_beta_offset_div2);
  H264_LOG(" slice_group_change_cycle : %d \n", sh->slice_group_change_cycle);

  H264_LOG("=== Prediction Weight Table ===\n");
  H264_LOG(" luma_log2_weight_denom : %d \n", sh->pwt.luma_log2_weight_denom);
  H264_LOG(" chroma_log2_weight_denom : %d \n", sh->pwt.chroma_log2_weight_denom);
  //   H264_LOG(" luma_weight_l0_flag : %d \n", sh->pwt.luma_weight_l0_flag );
     // int luma_weight_l0[64];
     // int luma_offset_l0[64];
 //    H264_LOG(" chroma_weight_l0_flag : %d \n", sh->pwt.chroma_weight_l0_flag );
     // int chroma_weight_l0[64][2];
     // int chroma_offset_l0[64][2];
  //   H264_LOG(" luma_weight_l1_flag : %d \n", sh->pwt.luma_weight_l1_flag );
     // int luma_weight_l1[64];
     // int luma_offset_l1[64];
 //    H264_LOG(" chroma_weight_l1_flag : %d \n", sh->pwt.chroma_weight_l1_flag );
     // int chroma_weight_l1[64][2];
     // int chroma_offset_l1[64][2];

  H264_LOG("=== Ref Pic List Reordering ===\n");
  H264_LOG(" ref_pic_list_modification_flag_l0 : %d \n", sh->rplm.ref_pic_list_modification_flag_l0);
  H264_LOG(" ref_pic_list_modification_flag_l1 : %d \n", sh->rplm.ref_pic_list_modification_flag_l1);
  // int modification_of_pic_nums_idc;
  // int abs_diff_pic_num_minus1;
  // int long_term_pic_num;

  H264_LOG("=== Decoded Ref Pic Marking ===\n");
  H264_LOG(" no_output_of_prior_pics_flag : %d \n", sh->drpm.no_output_of_prior_pics_flag);
  H264_LOG(" long_term_reference_flag : %d \n", sh->drpm.long_term_reference_flag);
  H264_LOG(" adaptive_ref_pic_marking_mode_flag : %d \n", sh->drpm.adaptive_ref_pic_marking_mode_flag);
...
{
  H264_LOG("======= Access Unit Delimiter =======\n");
...
void debug_seis(h264_stream_t* h)
{
  ...
  for (i = 0; i < num_seis; i++)
  {
    ...
    H264_LOG("=== %s ===\n", sei_type_name);
    H264_LOG(" payloadType : %d \n", s->payloadType);
    H264_LOG(" payloadSize : %d \n", s->payloadSize);
...
{
  H264_LOG("==================== NAL ====================\n");
  H264_LOG(" forbidden_zero_bit : %d \n", nal->forbidden_zero_bit);
  H264_LOG(" nal_ref_idc : %d \n", nal->nal_ref_idc);
